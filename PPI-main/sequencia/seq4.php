...
<body>
    ...
    <fieldset>
        ...
        <p class="central"> <img src="a1.jpg" alt="imagem central"></p>
        <div class="container">
        <p>
    ...
    <fieldset>
        <legend>Questão 2</legend>
                <p class="central"> <img src="a2.jpg" alt="imagem central"></p>
                <div class="container">
                <p>
    ...
    <fieldset>
        ...
        <p class="central"> <img src="a3.png" alt="imagem central"></p>
        <div class="container">
        <p>
Mestre Vitalino, importante ceramista popular brasileiro, na obra reproduzida, retrata uma cena típica da cultura nordestina: o horário da refeição. Seus bonecos de barro apresentam características artísticas marcantes, representadas como        </p>
    ...
    <fieldset>
        ...
        <p class="central"> <img src="a4.png" alt="imagem central"></p>
        <div class="container">
            <p>
        ...
        <fieldset>
            ...
            <p><div class="container">
                ...
                <p class="central"> <img src="a5.png" alt="imagem central"></p>
            <div class="container">
