...
<body>
    ...
    <fieldset>
        ...
        <p>
            ...
            Uerj (2024) - O quadro de Dalí, ao contrário do que muitos 
 ...
 Essa associação pode ser estabelecida de acordo com o princípio da:<br> </p>
    ...
    <fieldset>
        <legend>Questão 2</legend>
                ...
                <div class="container">
                <p>
                   Enem (2022) O termo ready-made foi criado por Marcel Duchamp (1887-1968) para designar um tipo de objeto, por ele inventado, que consiste em um ou mais artigos de uso cotidiano, produzidos em massa, selecionados sem critérios estéticos e expostos como obras de arte em espaços especializados (museus e galerias). Seu primeiro ready-made, de 1912, é uma roda de bicicleta montada sobre um banquinho (Roda de bicicleta).<br> Ao transformar qualquer objeto em obra de arte, o artista realiza uma crítica radical ao sistema da arte.
                </div>
                    <br>
                </p>
...
Enem (2021) - Produzida em 1919, a obra O crítico de arte, de Hausmann, utiliza procedimentos de composição que revelam a: </div><br>
        <label> <input type="radio" name="a3" value="1"> a) Visão satírica do artista em relação às convenções da arte burguesa.<br></label>
    ...
    <fieldset>
        ...
        <div class="container">
            <p> (ENEM 2019) <br>
                1. Nós queremos cantar o amor ao perigo, o hábito da energia e da temeridade. <br>
                ...
                5. Nós queremos entoar hinos ao homem que segura o volante, cuja haste ideal atravessa a Terra, lançada também numa corrida sobre o circuito da sua órbita. <br>
                6. É preciso que o poeta prodigalize com ardor, fausto e munificiência, para aumentar o entusiástico fervor dos elementos primordiais. <br>
            </p>
        ...
        <fieldset>
            ...
            <label> <input type="radio" name="a5" value="0"> a) A demanda por ampliação dos direitos políticos das populações periféricas.<br></label>
            <label> <input type="radio" name="a5" value="0"> b) Os maus tratos aplicados contra a população carcerária.<br></label>
            <label> <input type="radio" name="a5" value="0"> c) A violação dos direitos humanos das vítimas de violência doméstica.<br></label>
            <label> <input type="radio" name="a5" value="1"> d) O vínculo reforçado pela mídia entre o crime e um estereótipo de pessoas.<br></label>
            <label> <input type="radio" name="a5" value="0"> e) Os efeitos controversos das políticas afirmativas em território nacional.</label>
            <div class="but">
